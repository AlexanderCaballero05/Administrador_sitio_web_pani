...
<div class="modal-dialog modal-md">
        ...
        <div class="modal-body">
                <div class="form-group">
                <label for="tipo_sorteo" class="col-form-label">Tipo:</label>
                <select class="form-control" name="tipoSorteo" id="tipoSorteo" required ="valor solicitado">
                    <option disabled selected>Seleccione</option>
                    <?php
                            $consulta="SELECT*FROM tbl_tipo_imagen";
                            $resultado = $conexion->query($consulta);
                            foreach($resultado as $datos_sorteo){
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label style ="display:none;" for="Nsorteo" class="col-form-label" id="labelSorteo">Numero Sorteo:</label>
                    <input style ="display:none;" type="text" class="form-control" name="Nsorteo" id="Nsorteo" placeholder="Ejem: 1420">

                    <label style ="display:none;" for="NombreCarrucel" class="col-form-label" id="labelCarrucel">Posicion imagen:</label>
                    <select style ="display:none;" class="form-control" name="nombreCarrucel" id="nombreCarrucel">
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                    </select>

                    <label style ="display:none;" for="comite" class="col-form-label" id="labelComite">Comite:</label>
                    <select style ="display:none;" class="form-control" name="comite" id="comite">
                    <option value="1">SIELHO</option>
                    <option value="2">HONDUCOMPRAS</option>
                    <option value="3">ONADICI</option>
                    <option value="3">TSC</option>
                    <option value="3">P.Transparencia</option>
                </select>
                </div>
            </div>
...
<script type="text/javascript">
    $("#tipoSorteo").change(function(){
        if ($(this).val() === "1" || $(this).val() === "2" ){
            document.getElementById('Nsorteo').style.display= "block";
            document.getElementById('labelSorteo').style.display= "block";
            document.getElementById('nombreCarrucel').style.display= "none";
            document.getElementById('labelCarrucel').style.display= "none"
            document.getElementById('labelComite').style.display= "none";
            document.getElementById('comite').style.display= "none";
        } else if($(this).val() === "3") {
            document.getElementById('Nsorteo').style.display= "none";
            document.getElementById('labelSorteo').style.display= "none";
           document.getElementById('nombreCarrucel').style.display = "block";
            document.getElementById('labelCarrucel').style.display= "block"
            document.getElementById('labelComite').style.display= "none";
            document.getElementById('comite').style.display= "none";
        } else if(($(this).val() === "4")){
            document.getElementById('Nsorteo').style.display= "none";
            ...
            document.getElementById('nombreCarrucel').style.display = "none";
            document.getElementById('labelCarrucel').style.display= "none";
            document.getElementById('labelComite').style.display= "block";
            document.getElementById('comite').style.display= "block";
