            ...
            <div class="tabla-responsive">
                <table id="tablacImagen" class="table table-striped table-bordered table-condensed" style="width:100%">
                    <thead class="text-center">
                        <tr>
                            <th>Id</th>
                            <th>Nombre tipo de dato</th>
                            <th>Contenido</th>
                            <th>Acciones</th>
                        </tr>
                    </thead>
                    <tbody id="registros-dato-empresa">
                    </tbody>
                </table>
            </div>
        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-agregar-dato-empresa">           
                    <div class="row mb-5">
                        <div class="col-sm-12">
...
<script type="module" src="../controllers/controller_datosEmpresa.js"></script>
